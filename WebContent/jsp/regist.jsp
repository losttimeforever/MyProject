<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" autoFlush="true" buffer="8kb" session="true" isELIgnored="false" errorPage="/jsp/error.jsp"%>
...
<div class="row"> 
	...
	<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border:7px solid #ccc;">
		...
		<form class="form-horizontal" style="margin-top:5px;" action="/store_v2.0/UserServlet?method=regist" method="post">
			 ...
			 <div class="form-group">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="inputEmail3" name="telephone" placeholder="请输入电话">
			    </div>
			  </div>
