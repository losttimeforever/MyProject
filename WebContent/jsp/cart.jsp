		...
		<div class="container">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="${pageContext.request.contextPath }/UserServlet?method=order_info" id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath }/UserServlet?method=order_info">
